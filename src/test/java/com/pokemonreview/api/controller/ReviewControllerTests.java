...
public class ReviewControllerTests {
    ...
    @Test
    public void PokemonController_GetReviewsByPokemonId_ReturnReviewDto() throws Exception {
        int pokemonId = 1;
        when(reviewService.getReviewsByPokemonId(1)).thenReturn(Arrays.asList(reviewDto));
    ...
    @Test
    public void ReviewController_GetSingleReviewByPokemonId_ReturnReviewDto() throws Exception {
        int pokemonId = 1;
        int reviewId = 1;
